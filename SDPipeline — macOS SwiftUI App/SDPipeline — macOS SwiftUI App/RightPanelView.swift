...
// MARK: - RightPanelView v4
// Tabs: Output | Galería | Batch | Cola | IP-Adapter | Publicar | KPIs
// Añade:
//   • Tab IP-Adapter con IPAdapterPanel integrado
//   • Tab Output con ExternalEditorPanel y ACEScg grade access
//   • bottomBar con botón "Relight" vía ICLightEngine
//   • bottomBar con "Editor externo" vía ExternalEditorBridge
//   • stageBadge ampliado
