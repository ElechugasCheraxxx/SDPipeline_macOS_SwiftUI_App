...
// MARK: - ContentView+CenterPanel v3
//
// Cambios v2 → v3:
//   + presetsSection — acceso rápido a ReusableSettingsManager desde el centro
//   + pipelineFlagsSection ampliada: ControlNet, retry policy, atomic save toggle
//   + validationSection — resumen de warnings activos antes de generar
//   + centerPanel incluye presetsSection y validationSection
//
...
extension ContentView {
    ...
    // MARK: - Validation Section (v3 NEW)
    ...
    // MARK: - Presets Quick Section (v3 NEW)
    // Acceso rápido a los últimos 3 presets favoritos desde el panel de settings.
