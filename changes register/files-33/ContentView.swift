...
//
// Cambios v2 → v3:
//   + saveToVaultAtomic — usa PipelineSaveResult con desglose de pasos
//   + VaultResultBanner — banner rico con steg/iptc/sidecar status
//   + showPresetsPanel — panel de presets en sidebar izquierdo
//   + showSavePreset — sheet ReusableSettingsSaveSheet post-generación
//   + validationMsg muestra TODOS los warnings (allWarnings)
//   + ControlNet + ADetailer warnings en banner
//   + Botón "Guardar Preset" en parseButton area
//   + generate() usa saveToVaultAtomic internamente
