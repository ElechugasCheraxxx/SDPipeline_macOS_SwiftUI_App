...
struct RightPanelView: View {
    ...
    @State fileprivate var vaultMessage:    String?  = nil
    @State private var isVaulting:      Bool     = false
    @State private var isRelighting:    Bool     = false
    @State private var showACEScg:      Bool     = false
    @State fileprivate var vaultSaveResult: PipelineConnector.PipelineSaveResult? = nil
    ...
    @StateObject fileprivate var assetStore     = AssetStore.shared                 // NEW v6
                    ...
                    ForEach(manager.selectedLoRAs) { sel in
                        HStack(spacing: 8) {
                            ...
                            Text(String(format: "%.2f", sel.weight))
                                ...
                                .foregroundColor(Color(hex: "#7c6af7"))
                                .onTapGesture { showWeightEditor = sel.id }
