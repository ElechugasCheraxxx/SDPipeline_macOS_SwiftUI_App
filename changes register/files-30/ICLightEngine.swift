...
//
// Modos soportados:
//   • FC  (Foreground Conditioned) — sujeto + prompt de luz
//   • FBC (Foreground + Background Conditioned) — sujeto + fondo + prompt
//   • Background removal automático antes de relight
//
// Integración: IC-Light como extensión ComfyUI o via API REST dedicada.
// Fallback: simulación via img2img con prompts de iluminación + bajo denoising.
//
// ROADMAP: "Relight cinemático con IC-Light" (🟡 MEDIO PLAZO)
...
final class ICLightEngine: ObservableObject {
    ...
    struct ICLightConfig: Codable {
        ...
        var backgroundImage:  String?           = nil  // path para modo FBC
        var strength:         Double            = 0.7   // 0-1, fuerza del relight
        var denoisingStrength: Double           = 0.35  // para fallback img2img
    ...
    /// Ejecuta IC-Light sobre una imagen. Retorna la imagen re-iluminada.
    ...
    /// Relight usando IC-Light API (ComfyUI o extensión A1111).
    private func relightViaICLight(image: NSImage, cfg: ICLightConfig) async throws -> NSImage {
        ...
        // Preparar payload para IC-Light API
        ...
        // IC-Light generalmente corre en puerto 7861 o como workflow ComfyUI
    ...
    /// Fallback: simular relight via img2img con prompt de iluminación.
    ...
    private func loadPresets() {
        ...
        // Cargar presets de usuario desde vault
