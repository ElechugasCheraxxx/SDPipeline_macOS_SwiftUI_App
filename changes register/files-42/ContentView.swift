...
struct ContentView: View {
    ...
    @StateObject fileprivate var sdService       = SDService()
...
"""
    @State fileprivate var parsedPrompt:  String  = ""
    @State private var parseError:    String? = nil
    @State fileprivate var settings             = GenerationSettings()
    ...
    @State fileprivate var validationMsg: String? = nil
    ...
    @StateObject fileprivate var assetStore      = AssetStore.shared
    @StateObject private var loraManager     = LoRAManager.shared
    @StateObject fileprivate var characterEngine = CharacterEngine.shared
