...
extension PublishComplianceLogger {
    ...
    /// GDPR compliance flags derived from stored configuration (UserDefaults-backed).
    var gdprFlags: GDPRFlags {
        GDPRFlags(
            retentionDays:   UserDefaults.standard.integer(forKey: "compliance.retentionDays")  > 0
                             ? UserDefaults.standard.integer(forKey: "compliance.retentionDays")
                             : 90,
            rightToErasure:  UserDefaults.standard.object(forKey: "compliance.rightToErasure")  == nil
                             ? true
                             : UserDefaults.standard.bool(forKey: "compliance.rightToErasure"),
            consentRequired: UserDefaults.standard.object(forKey: "compliance.consentRequired") == nil
                             ? true
                             : UserDefaults.standard.bool(forKey: "compliance.consentRequired")
        )
    }
