...
// MARK: - ExportEngine.WatermarkConfig position extension

extension ExportEngine.WatermarkConfig.Position: CaseIterable {
    public static var allCases: [ExportEngine.WatermarkConfig.Position] {
